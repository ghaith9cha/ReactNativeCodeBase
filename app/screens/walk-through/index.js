...
import { Platform, View, ScrollView, Text, StatusBar, SafeAreaView, Button, Pressable, I18nManager } from 'react-native';
import LinearGradient from 'react-native-linear-gradient';
import Carousel, { Pagination } from 'react-native-snap-carousel';
import { sliderWidth, itemWidth } from './slideEntry.style';
...
export default class WalkThroughScreen1 extends Component {
                    ...
                    <ScrollView
                        ...
                        <View style={styles.buttonsStyle}>
                            ...
                            <View>
                                ...
                                <Pressable
                                    onPress={() => { this._slider1Ref.currentIndex === ENTRIES1.length - 1 ? this.props.navigation.navigate('login') : this._slider1Ref.snapToNext() }}
                                    style={styles.prevButton}
                                >
                                    <Text>   {t("walk_through.next")} </Text>
